...
Wraps the system `ping` command to send a stream of ICMP packets at a
specified interval, parsing the output to provide detailed statistics
including min/avg/max/stddev RTT and precise packet loss percentages.

Usage:
    check_latency.py [-h] [-d DURATION] [-t TARGET] [-i INTERVAL]
    check_latency.py                  # default: 10 mins, target 8.8.8.8
    check_latency.py -d 5 -t 1.1.1.1  # 5 mins, target 1.1.1.1
    check_latency.py -i 0.5           # interval of 0.5s between pings
"""
